class BlogData:
    blogs = [
        ...
        {
            "title": "Tips Mengatasi Lupa Presensi",
            ...
            "content": """
                <p>Lupa presensi memang sering terjadi, apalagi jika kamu memiliki jadwal kuliah yang padat. Tetapi, ada beberapa tips yang bisa kamu lakukan untuk mengatasi lupa presensi:</p>
                <ol>
                ...
                <p>Dengan menerapkan tips ini, diharapkan kamu tidak lagi mengalami masalah lupa presensi.</p>
            """
        },
        {
            ...
            "content": """
                <p>Generator presensi otomatis ini adalah fitur andalan kami yang dirancang untuk membantu mengatasi masalah lupa presensi. Dengan fitur ini, kamu bisa menghasilkan kode presensi baru secara otomatis, berdasarkan kode presensi lama yang kamu miliki. Yuk, simak panduan lengkapnya:</p>
                ...
                <p>Tunggu apa lagi? Gunakan generator presensi otomatis sekarang juga dan nikmati kemudahan anti ribet presensi! Kunjungi halaman <a href="https://lupa-presensi.vercel.app/">generator presensi</a> dan mulai sekarang!</p>
            """
        },
    ]